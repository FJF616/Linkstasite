...
var PictureList = createReactClass({
    ...
    render: function() {
        ...
        return (
            ...
            <div className="pic__list" style={{backgroundColor: 'transparent'}}>
                <h1>Your Instagram pics</h1>
                <div className="pictures" style={{backgroundColor: 'lightcyan'}}> {pictures} </div>
